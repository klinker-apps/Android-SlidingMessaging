...
public class PullToRefreshAttacher implements View.OnTouchListener {
    ...
    public static boolean dialogTheme;

    /**
     * FIXME
     * @param activity
     */
    public PullToRefreshAttacher(Activity activity, boolean lightActionBar, boolean dialogTheme) {
        this(activity, new Options(), lightActionBar, dialogTheme);
    }
     ...
     * @param options
     */
    public PullToRefreshAttacher(Activity activity, Options options, boolean lightActionBar, boolean dialogTheme) {
        if (options == null) {
    ...
    public static class EnvironmentDelegate {
        ...
        public Context getContextForInflater(Activity activity) {
            if (Build.VERSION.SDK_INT >= 14 && !dialogTheme) {
    ...
    public class DefaultHeaderTransformer extends HeaderTransformer {
        ...
        public void onViewCreated(Activity activity, View headerView) {
            ...
            if (lightActionBar) {
                mHeaderTextView.setTextColor(activity.getResources().getColor(R.color.darkgrey));
            } else {
                mHeaderTextView.setTextColor(activity.getResources().getColor(R.color.grey));
            }
        ...
        protected Drawable getActionBarBackground(Context context) {
            if (lightActionBar) {
                return context.getResources().getDrawable(R.drawable.ab_hangouts);
            } else {
                return context.getResources().getDrawable(R.drawable.dark_action_bar);
            }
        }
