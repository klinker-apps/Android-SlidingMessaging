 ...
 * swing-in-from-top-animation to views.
 */
public class SwingTopInAnimatorAdapter extends SingleAnimationAdapter {

    private final long mAnimationDelayMillis;
    private final long mAnimationDurationMillis;

    public SwingTopInAnimatorAdapter(BaseAdapter baseAdapter) {
        this(baseAdapter, DEFAULTANIMATIONDELAYMILLIS, DEFAULTANIMATIONDURATIONMILLIS);
    }

    public SwingTopInAnimatorAdapter(BaseAdapter baseAdapter, long animationDelayMillis) {
        this(baseAdapter, animationDelayMillis, DEFAULTANIMATIONDURATIONMILLIS);
    }

    public SwingTopInAnimatorAdapter(BaseAdapter baseAdapter, long animationDelayMillis, long animationDurationMillis) {
        super(baseAdapter);
