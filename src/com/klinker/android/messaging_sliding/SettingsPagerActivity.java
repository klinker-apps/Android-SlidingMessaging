...
//            });
        ...
        public void setUpAdvancedSettings()
        {
            ...
            restore.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    ...
                    if (sharedPrefs.getBoolean("background_service", false))
                    {
                        final ProgressDialog progDialog = new ProgressDialog(context);
                        progDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                        progDialog.setMessage(context.getResources().getString(R.string.caching));
                        progDialog.show();
                        ...
                        new Thread(new Runnable(){
                            ...
                            public void run() {
                                ...
                                Cursor query = getActivity().getContentResolver().query(uri, projection, null, null, "date desc");
                                    ...
                                    do
                                    {
                                        ...
                                        for (int i = 0; i < ids.length; i++)
                                        {
                                            try
                                            {
                                                ...
                                                {
                                                    Cursor number = getActivity().getContentResolver().query(Uri.parse("content://mms-sms/canonical-addresses"), null, "_id=" + ids[i], null, null);
            ...
            backgroundService.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
