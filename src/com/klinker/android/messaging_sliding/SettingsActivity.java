...
//		         });
		...
		titleSettings.setOnPreferenceClickListener(new OnPreferenceClickListener() {
		             public boolean onPreferenceClick(Preference preference) {
		            	 Intent intent = new Intent(context2, TitleBarSettingsActivity.class);
		     			 startActivity(intent);
		                 return true;
		             }
		         });
		...
		customThemeSettings.setOnPreferenceClickListener(new OnPreferenceClickListener() {
		             public boolean onPreferenceClick(Preference preference) {
		            	 Intent intent = new Intent(context2, ThemeChooserActivity.class);
		            	 startActivity(intent);
		...
		customBackground.setOnPreferenceClickListener(new OnPreferenceClickListener() {
		...
		customBackground2.setOnPreferenceClickListener(new OnPreferenceClickListener() {
