...
public class DownloadManager {
        ...
        try {
            ...
            if ((nInd.getExpiry() < System.currentTimeMillis()/1000L)
                ...
                mHandler.post(new Runnable() {
                    public void run() {
                        Toast.makeText(mContext, com.klinker.android.messaging_donate.R.string.error,
    ...
    private String getMessage(Uri uri) throws MmsException {
        ...
        String subject = (v != null) ? v.getString()
                : mContext.getString(com.klinker.android.messaging_donate.R.string.error);
        ...
        return mContext.getString(com.klinker.android.messaging_donate.R.string.error, subject, from);
    }
