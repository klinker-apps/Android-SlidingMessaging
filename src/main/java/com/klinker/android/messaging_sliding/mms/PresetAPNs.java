...
public class PresetAPNs {
    ...
    public static String[] apns = {
            ...
            "AT&T_#2_(Try_this_if_first_doesn't_work_for_you)--http://mmsc.mobile.att.net, proxy.mobile.att.net, 80",
            "Bell_Canada--http://mms.bell.ca/mms/wapenc, web.wireless.bell.ca, 80",
            "Boost--http://mm.myboostmobile.com, 68.28.31.7, 80",
            "Bouygues_Telecom--http://mms.bouyguestelecom.fr/mms/wapenc, 62.201.129.226, 8080",
            "Fido_Canada--http://mms.fido.ca, 205.151.11.13, 80",
            "Free_Mobile_France--http://212.27.40.225, 212.27.40.225, 80",
            "Koodo--http://aliasredirect.net/proxy/koodo/mmsc, 74.49.0.18, 80﻿",
            "Network_Norway--http://mms.nwn.no, 188.149.250.10, 80",
